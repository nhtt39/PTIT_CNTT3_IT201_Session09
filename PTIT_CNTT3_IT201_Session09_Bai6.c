...
int main() {
    ...
    int newValue;
    printf("Nhập một số nguyên dương để thêm vào đầu danh sách: ");
    scanf("%d", &newValue);
    ...
    if (newValue <= 0) {
        ...
        printf("Danh sách liên kết sau khi thêm %d vào đầu: ", newValue);
        printList(head);
    }

    // Xóa phần tử đầu tiên
    printf("Xóa phần tử đầu tiên...\n");
    head = deleteHead(head);
    printf("Danh sách liên kết sau khi xóa phần tử đầu: ");
    printList(head);
